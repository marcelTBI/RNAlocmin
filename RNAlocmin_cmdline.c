...
const char *gengetopt_args_info_purpose = "Calculate local minima from RNAsubopt -p output file";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -d, --depth=INT            Depth of findpath search (higher values increase \n                               running time)  (default=`10')",
  "      --minh=DOUBLE          Print only minima with energy barrier greater than \n                               this  (default=`0.0')",
  "      --noLP                 Work with canonical RNA structures (w/o isolated \n                               base pairs)  (default=off)",
  "  -b, --bartree              Generate possible barrier tree  (default=off)",
  "  -e, --useEOS               Use energy_of_structure_pt calculation instead of \n                               energy_of_move (slower, it should not affect \n                               results)  (default=off)",
  "      --useFirst             Use first found lower energy structure instead of \n                               deepest  (default=off)",
  "      --floodPortion=DOUBLE  Fraction of minima to flood\n                               (0.0 -> no flood; 1.0 -> try to flood all of \n                               them)  (default=`0.95')",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->move_help = gengetopt_args_info_help[2] ;
  args_info->min_num_help = gengetopt_args_info_help[3] ;
  args_info->find_num_help = gengetopt_args_info_help[4] ;
  args_info->seq_help = gengetopt_args_info_help[5] ;
  args_info->verbose_lvl_help = gengetopt_args_info_help[6] ;
  args_info->rates_help = gengetopt_args_info_help[7] ;
  args_info->rates_file_help = gengetopt_args_info_help[8] ;
  args_info->temp_help = gengetopt_args_info_help[9] ;
  args_info->depth_help = gengetopt_args_info_help[10] ;
  args_info->minh_help = gengetopt_args_info_help[11] ;
  args_info->noLP_help = gengetopt_args_info_help[12] ;
  args_info->bartree_help = gengetopt_args_info_help[13] ;
  args_info->useEOS_help = gengetopt_args_info_help[14] ;
  args_info->useFirst_help = gengetopt_args_info_help[15] ;
  args_info->floodPortion_help = gengetopt_args_info_help[16] ;
  args_info->floodMax_help = gengetopt_args_info_help[17] ;
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->useFirst_given)
    write_into_file(outfile, "useFirst", 0, 0 );
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVm:n:s:v:rf:T:d:be", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'n':	/* Maximal number of local minima returned.  */
          ...
          if (update_arg( (void *)&(args_info->min_num_arg), 
              ...
              &(local_args_info.min_num_given), optarg, 0, "100", ARG_INT,
              check_ambiguity, override, 0, 0,
              "min-num", 'n',
              additional_error))
            goto failure;
          ...
          break;
        case 's':	/* Sequence file in FASTA format.  */
          ...
          break;
        case 'v':	/* Level of verbosity (0 = nothing, 4 = full)\n WARNING: higher verbose levels increase computation time.  */
        ...
        case 'T':	/* Temperature in Celsius (only for rates).  */
          ...
          break;
        case 'd':	/* Depth of findpath search (higher values increase running time).  */
          ...
          break;
        case 'b':	/* Generate possible barrier tree.  */
        ...
        case 0:	/* Long option with no short option */
          ...
          /* Work with canonical RNA structures (w/o isolated base pairs).  */
          ...
          /* Use first found lower energy structure instead of deepest.  */
          else if (strcmp (long_options[option_index].name, "useFirst") == 0)
          {
          
          
            if (update_arg((void *)&(args_info->useFirst_flag), 0, &(args_info->useFirst_given),
                &(local_args_info.useFirst_given), optarg, 0, 0, ARG_FLAG,
                check_ambiguity, override, 1, 0, "useFirst", '-',
                additional_error))
              goto failure;
          
          }
          /* Fraction of minima to flood\n(0.0 -> no flood; 1.0 -> try to flood all of them).  */
